...
public class Counter {
    ...
    private void warnOP() {
        Bukkit.getScheduler().runTaskLater((Plugin)CpsCounter.getInstance(), () -> {
            ...
            if (System.currentTimeMillis() > this.timeout) {
                ...
                for (Player op : Bukkit.getOnlinePlayers()) {
                    ...
                    op.sendMessage("\u00a7b[CPS] \u00a7c\u73a9\u5bb6 " + this.player.getName() + " \u5efa\u8bae\u68c0\u67e5\u662f\u5426\u8fde\u70b9\u00a7b | \u00a7cCPS \u00a7e" + this.getCPS() + "\u00a7c / \u00a7d" + this.getMaxCPS() + "\u00a7b | \u00a7cRCS \u00a7e" + this.getRightCPS() + "\u00a7c / \u00a7d" + this.getRightMaxCPS() + "\u00a7b | \u00a7cLCS \u00a7e" + this.getLeftCPS() + "\u00a7c / \u00a7d" + this.getLeftMaxCPS());
                }
            }
        }, 7L);
    }
